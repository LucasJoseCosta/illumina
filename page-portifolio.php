            ...
            <div class="portifolio-header-client-filter">
                <div class="portifolio-header-client-filter-wrapper">
                    ...
                    <button type="button" class="client-filter-toggle">
                        <span class="client-filter-current"><?php echo pll_e('Filtrar por Clientes') ?></span>
                        <span class="client-filter-icon-mobile">
                ...
                <div class="portifolio-terms-content">
                    ...
                    if (is_array($termos_portifolio) && count($termos_portifolio) > 0) {
                        foreach ($termos_portifolio as $termo_obj) {
                            ...
                            $term_name_for_display_mobile = isset($termo_obj['termo_mobile']) ? $termo_obj['termo_mobile'] : 'Termo Inválido';
                            ...
                            <div class="portifolio-terms-item">
                                <div class="portifolio-terms-item-button">
                                    <a href="javascript:void(0);"
                                        ...
                                        <span
                                            class="btn-portifolio-terms-text-mobile"><?php echo esc_html($term_name_for_display_mobile); ?></span>
                                    </a>
                                </div>
                            </div>
                            <?php
...
<section class="portifolio-items">
    <?php
    ...
    if (!empty($final_posts_to_display)) {
        echo '<div class="portfolio-items-container container">';
        $index = 0;
